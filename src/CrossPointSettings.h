...
class CrossPointSettings {
 ...
 public:
  ...
  enum SHORT_PWRBTN { IGNORE = 0, SLEEP = 1, PAGE_TURN = 2, CONFIRM_BTN = 3, SHORT_PWRBTN_COUNT };
  ...
  // TruyenJs2 story server settings (up to 3 libraries)
  char truyenServerUrl[128] = "";
  char truyenServerName[64] = "";
  char truyenServerUrl2[128] = "";
  char truyenServerName2[64] = "";
  char truyenServerUrl3[128] = "";
  char truyenServerName3[64] = "";
  // Hide battery percentage
