...
#include "browser/TruyenBrowserActivity.h"
...
void ActivityManager::goToTruyenBrowser() {
  replaceActivity(std::make_unique<TruyenBrowserActivity>(renderer, mappedInput));
}
