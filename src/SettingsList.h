...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_SHORT_PWR_BTN, &CrossPointSettings::shortPwrBtn,
                        {StrId::STR_IGNORE, StrId::STR_SLEEP, StrId::STR_PAGE_TURN, StrId::STR_CONFIRM_BTN},
      ...
      // --- Story Library (TruyenJs2) ---
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_URL, SETTINGS.truyenServerUrl, sizeof(SETTINGS.truyenServerUrl),
                          "truyenServerUrl", StrId::STR_TRUYEN_BROWSER),
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_NAME, SETTINGS.truyenServerName, sizeof(SETTINGS.truyenServerName),
                          "truyenServerName", StrId::STR_TRUYEN_BROWSER),
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_URL_2, SETTINGS.truyenServerUrl2, sizeof(SETTINGS.truyenServerUrl2),
                          "truyenServerUrl2", StrId::STR_TRUYEN_BROWSER),
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_NAME_2, SETTINGS.truyenServerName2,
                          sizeof(SETTINGS.truyenServerName2), "truyenServerName2", StrId::STR_TRUYEN_BROWSER),
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_URL_3, SETTINGS.truyenServerUrl3, sizeof(SETTINGS.truyenServerUrl3),
                          "truyenServerUrl3", StrId::STR_TRUYEN_BROWSER),
      SettingInfo::String(StrId::STR_TRUYEN_SERVER_NAME_3, SETTINGS.truyenServerName3,
                          sizeof(SETTINGS.truyenServerName3), "truyenServerName3", StrId::STR_TRUYEN_BROWSER),
